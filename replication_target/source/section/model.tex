...
We refer to these two instantiations as CLIGen, our command-line interface (CLI) prototype (\Cref{section:impl-cligen}), and GUIWorld, our graphical user interface (GUI) prototype (\Cref{section:impl-guiworld}).
