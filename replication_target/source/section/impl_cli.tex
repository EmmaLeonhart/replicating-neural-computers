...
\begin{wraptable}{r}{0.42\linewidth}
  ...
  \end{tabularx}
\end{wraptable}
The paper on NeuralOS~\citep{rivard2025neuralos} argues that generic natural-image VAEs can perform poorly on structured computer screenshots.
We test this directly by applying the Wan2.1 VAE~\citep{wan2025wan} to terminal content.
